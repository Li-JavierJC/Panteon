...
Descripcion:Creacion de la clase Difunto, incluyento atributos, metodo constructor, descriptores de acceso y metodo mostrar
...
*/
	...
	public function setFecha_difuncion($fecha_difuncion){
		$this->fecha_difuncion=$fecha_difuncion;
	}
	//Metoddo get del atributo fecha_difuncion
	public function getFecha_difuncion(){
		return $this->fecha_difuncion=$fecha_difuncion;
	}
